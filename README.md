...
* test_external_api.py - данный модуль содержит тест на конвертацию валюты с помощью обращения к внешнему API для получения текущего курса валют;
* test_generators.py - данный модуль тестирует функции вывода результатов транзакций;
* test_information_search.py - данный модуль тестирует функции на вывод данных по категориям и по заданной строке;
...
* test_reading_files.py - данный модуль содержит тесты для функции считывания финансовых операций из CSV и excel файлов;
* test_utils.py - данный модуль содержит тест на то, принимает ли функция на вход путь до JSON-файла и возвращает ли 
список словарей с данными о финансовых транзакциях;
* test_widget.py - данный модуль содержит тестовые функции для обработки наименования карты/счета и введенной даты.

## Логирование
Логирование корректной работы функции и возникающих ошибок реализовано в модулях **masks** и **utils**.
